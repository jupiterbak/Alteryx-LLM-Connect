...
export const config: { supported_platforms: Platform[] } = {
  supported_platforms: [
    ...
    // Clarifai
    {
      ...
      api_url: "https://api.clarifai.com/v2/models/{model_id}/outputs",
      doc_url: "https://docs.clarifai.com/api-guide/api-overview/helpful-api-resources/using-postman-with-clarifai-apis"
    },
    // Cohere
    {
      name: "Cohere",
